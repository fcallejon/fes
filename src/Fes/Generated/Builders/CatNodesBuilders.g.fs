...
module CatNodesBuilders =
    ...
    type NodesRecordBuilder() =
        member _.Yield(_: unit) : NodesRecord =
            {
                Id = None
                Pid = None
                Ip = None
        ...
        [<CustomOperation("pid")>]
        member _.Pid(state: NodesRecord, value: string) =
            { state with Pid = Some value }

        [<CustomOperation("ip")>]
        member _.Ip(state: NodesRecord, value: string) =
            { state with Ip = Some value }

        [<CustomOperation("port")>]
        member _.Port(state: NodesRecord, value: string) =
            { state with Port = Some value }

        [<CustomOperation("httpAddress")>]
        member _.HttpAddress(state: NodesRecord, value: string) =
        ...
        member _.Flavor(state: NodesRecord, value: string) =
            { state with Flavor = Some value }

        [<CustomOperation("type'")>]
        member _.Type(state: NodesRecord, value: string) =
            { state with Type = Some value }

        [<CustomOperation("build")>]
        member _.Build(state: NodesRecord, value: string) =
            { state with Build = Some value }

        [<CustomOperation("jdk")>]
        member _.Jdk(state: NodesRecord, value: string) =
        ...
        member _.HeapCurrent(state: NodesRecord, value: string) =
        ...
        member _.HeapMax(state: NodesRecord, value: string) =
            { state with HeapMax = Some value }

        [<CustomOperation("ramCurrent")>]
        member _.RamCurrent(state: NodesRecord, value: string) =
        ...
        member _.RamMax(state: NodesRecord, value: string) =
            { state with RamMax = Some value }

        [<CustomOperation("fileDescCurrent")>]
        member _.FileDescCurrent(state: NodesRecord, value: string) =
        ...
        member _.FileDescMax(state: NodesRecord, value: string) =
            { state with FileDescMax = Some value }

        [<CustomOperation("cpu")>]
        member _.Cpu(state: NodesRecord, value: string) =
            { state with Cpu = Some value }

        [<CustomOperation("load1m")>]
        member _.Load1m(state: NodesRecord, value: string) =
            { state with Load1m = Some value }

        [<CustomOperation("load5m")>]
        member _.Load5m(state: NodesRecord, value: string) =
            { state with Load5m = Some value }

        [<CustomOperation("load15m")>]
        member _.Load15m(state: NodesRecord, value: string) =
            { state with Load15m = Some value }

        [<CustomOperation("availableProcessors")>]
        member _.AvailableProcessors(state: NodesRecord, value: string) =
            { state with AvailableProcessors = Some value }

        [<CustomOperation("uptime")>]
        member _.Uptime(state: NodesRecord, value: string) =
            { state with Uptime = Some value }

        [<CustomOperation("nodeRole")>]
        member _.NodeRole(state: NodesRecord, value: string) =
            { state with NodeRole = Some value }

        [<CustomOperation("master")>]
        member _.Master(state: NodesRecord, value: string) =
