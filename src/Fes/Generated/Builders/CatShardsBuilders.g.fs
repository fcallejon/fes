...
module CatShardsBuilders =
    ...
    type ShardsRecordBuilder() =
        member _.Yield(_: unit) : ShardsRecord =
            {
                Index = None
                Shard = None
                Prirep = None
