...
module TypesBuilders =
    ...
    let createFieldSort (value: Types.SortOrder) : Types.FieldSort =
        {
            Missing = None
            Mode = None
            Nested = None
    ...
    type KnnSearchBuilder() =
        ...
        member _.QueryName(state: Types.KnnSearch, value: string) =
    ...
    let createScript (value: Types.ScriptSource) : Types.Script =
        {
            Source = Some value
            Id = None
            Params = None
