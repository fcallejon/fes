...
module GlobalSearchTypesBuilders =
    ...
    let ofContext (value: Types.GlobalSearchTypesContext) : Types.CompletionContext =
        {
            Boost = None
            Context = value
            Neighbours = None
    ...
    type RescoreQueryBuilder() =
        ...
        member _.RescoreQuery(state: Types.RescoreQuery, value: Types.QueryContainer) =
    ...
    let ofIncludes (value: Types.Fields) : Types.SourceFilter =
        {
            ExcludeVectors = None
            Excludes = None
            Includes = value
