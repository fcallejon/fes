...
module AsyncSearchOperations =
    ...
    type AsyncSearchGetResponse = Types.AsyncSearchDocumentResponseBase<Types.TDocument>
    ...
    type AsyncSearchSubmitResponse = Types.AsyncSearchDocumentResponseBase<Types.TDocument>
