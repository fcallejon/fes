...
module QueryRulesOperations =
    ...
    type QueryRulesDeleteRuleRequest = {
        ...
        with
        static member ToRequest(req: QueryRulesDeleteRuleRequest) : Result<Fes.Http.RequestMsg, exn> =
            try
    ...
    type QueryRulesDeleteRulesetRequest = {
        ...
        with
        static member ToRequest(req: QueryRulesDeleteRulesetRequest) : Result<Fes.Http.RequestMsg, exn> =
            try
    ...
    type QueryRulesGetRuleRequest = {
        ...
        with
        static member ToRequest(req: QueryRulesGetRuleRequest) : Result<Fes.Http.RequestMsg, exn> =
            try
                let path = $"/_query_rules/{req.RulesetId}/_rule/{req.RuleId}"
                let fullPath = path
                fullPath
    ...
    type QueryRulesGetRuleResponse = QueryRulesTypes.QueryRule
    ...
    type QueryRulesGetRulesetRequest = {
        ...
        with
        static member ToRequest(req: QueryRulesGetRulesetRequest) : Result<Fes.Http.RequestMsg, exn> =
            try
                let path = $"/_query_rules/{req.RulesetId}"
                let fullPath = path
                fullPath
    ...
    type QueryRulesGetRulesetResponse = QueryRulesTypes.QueryRuleset
    ...
    type QueryRulesListRulesetsRequest = {
        ...
        with
        static member ToRequest(req: QueryRulesListRulesetsRequest) : Result<Fes.Http.RequestMsg, exn> =
            try
    ...
    type QueryRulesPutRuleRequest = {
        ...
        with
        static member ToRequest(req: QueryRulesPutRuleRequest) : Result<Fes.Http.RequestMsg, exn> =
            try
                let path = $"/_query_rules/{req.RulesetId}/_rule/{req.RuleId}"
                let fullPath = path
                fullPath
    ...
    type QueryRulesPutRuleRequestBuilder() =
        ...
        member _.Type(state: QueryRulesPutRuleRequest, value: QueryRulesTypes.QueryRuleType) =
        ...
        member _.Actions(state: QueryRulesPutRuleRequest, value: QueryRulesTypes.QueryRuleActions) =
    ...
    module PutRule =
        let withType (value: QueryRulesTypes.QueryRuleType) (req: QueryRulesPutRuleRequest) =
            { req with Type = value }
    ...
    type QueryRulesPutRulesetRequest = {
        ...
        with
        static member ToRequest(req: QueryRulesPutRulesetRequest) : Result<Fes.Http.RequestMsg, exn> =
            try
                let path = $"/_query_rules/{req.RulesetId}"
                let fullPath = path
                fullPath
    ...
    type QueryRulesTestRequest = {
        ...
        with
        static member ToRequest(req: QueryRulesTestRequest) : Result<Fes.Http.RequestMsg, exn> =
            try
